...
const images = [
  { id: '1', src: require('./assets/1.jpg'), targetScreen: 'PatchInfoPage' },
  { id: '2', src: require('./assets/2.jpg'), targetScreen: 'PatchInfoPage' },
  { id: '3', src: require('./assets/3.jpg'), targetScreen: 'PatchInfoPage' },
];
...
export default function SpecificScarf() {
