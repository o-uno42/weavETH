...
export interface IVPToken$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "IVPToken",
  "sourceName": "@flarenetwork/flare-periphery-contracts/coston2/IVPToken.sol",
  "abi": [
    {
      "anonymous": false,
      "inputs": [
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IVPToken$Type["abi"]>>;
  export function deployContract(
    contractName: "@flarenetwork/flare-periphery-contracts/coston2/IVPToken.sol:IVPToken",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IVPToken$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IVPToken$Type["abi"]>;
