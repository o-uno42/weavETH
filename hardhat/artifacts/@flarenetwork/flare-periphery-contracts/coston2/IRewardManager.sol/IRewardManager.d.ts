...
export interface IRewardManager$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "IRewardManager",
  "sourceName": "@flarenetwork/flare-periphery-contracts/coston2/IRewardManager.sol",
  "abi": [
    {
      "anonymous": false,
      "inputs": [
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IRewardManager$Type["abi"]>>;
  export function deployContract(
    contractName: "@flarenetwork/flare-periphery-contracts/coston2/IRewardManager.sol:IRewardManager",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IRewardManager$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IRewardManager$Type["abi"]>;
