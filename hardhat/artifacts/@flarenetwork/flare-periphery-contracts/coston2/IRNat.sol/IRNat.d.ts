...
export interface IRNat$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "IRNat",
  "sourceName": "@flarenetwork/flare-periphery-contracts/coston2/IRNat.sol",
  "abi": [
    {
      "anonymous": false,
      "inputs": [
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IRNat$Type["abi"]>>;
  export function deployContract(
    contractName: "@flarenetwork/flare-periphery-contracts/coston2/IRNat.sol:IRNat",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IRNat$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IRNat$Type["abi"]>;
