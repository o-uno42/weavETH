...
export interface IRelay$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "IRelay",
  "sourceName": "@flarenetwork/flare-periphery-contracts/coston2/IRelay.sol",
  "abi": [
    {
      "anonymous": false,
      "inputs": [
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IRelay$Type["abi"]>>;
  export function deployContract(
    contractName: "@flarenetwork/flare-periphery-contracts/coston2/IRelay.sol:IRelay",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IRelay$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IRelay$Type["abi"]>;
