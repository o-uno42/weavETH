...
export interface IIFtso$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "IIFtso",
  "sourceName": "@flarenetwork/flare-periphery-contracts/coston2/ftso/interface/IIFtso.sol",
  "abi": [
    {
      "anonymous": false,
      "inputs": [
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IIFtso$Type["abi"]>>;
  export function deployContract(
    contractName: "@flarenetwork/flare-periphery-contracts/coston2/ftso/interface/IIFtso.sol:IIFtso",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IIFtso$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IIFtso$Type["abi"]>;
